...
public class TestFilesystemModificationListener implements IFilesystemModificationListener {

	final ArrayList<ChangeEvent> events = new ArrayList<IFilesystemModificationListener.ChangeEvent>();
