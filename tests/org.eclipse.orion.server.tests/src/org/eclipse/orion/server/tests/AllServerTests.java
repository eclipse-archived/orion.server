 ...
 */
@RunWith(Suite.class)
@SuiteClasses({TransferTest.class, CoreFilesTest.class, AdvancedFilesTest.class, PreferenceTest.class, BasicUsersTest.class, WorkspaceServiceTest.class, XmlUserAdminTest.class, PreferenceTest.class})
