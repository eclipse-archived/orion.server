 ...
 */
@RunWith(Suite.class)
@SuiteClasses({GitUriTest.class, GitCloneTest.class, GitInitTest.class, GitDiffTest.class, GitStatusTest.class, GitIndexTest.class, GitAddTest.class, GitResetTest.class, GitCommitTest.class, GitConfigTest.class, GitRemoteTest.class, GitFetchTest.class, GitMergeTest.class, GitRebaseTest.class, GitPushTest.class, GitLogTest.class, GitTagTest.class, GitUtilsTest.class, GitCheckoutTest.class, GitBranchTest.class, GitCherryPickTest.class, GitPullTest.class})
