...
public abstract class GitTest extends FileSystemTest {
	...
	protected JSONObject createFileUsingPostRequest(JSONObject locationJSON, String filename) throws Exception {
	...
	protected JSONObject getProjectDataFromInitialObject(JSONObject project) throws Exception {
