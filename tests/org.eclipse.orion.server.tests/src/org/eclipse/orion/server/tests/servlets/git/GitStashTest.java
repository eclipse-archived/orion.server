...
public class GitStashTest extends GitTest {
	...
	private void assertNextLocation(int expectedPage, int expectedSize, String nextLocationString) throws Exception {

		URI nextLocation = new URI(nextLocationString);

		String baseLocation = nextLocation.getPath();
		String expectedParameterString = GitUtils.constructStashNextLocationString(baseLocation, expectedPage, expectedSize);

		assertEquals(expectedParameterString, nextLocationString);
	}
