...
public class GitStashTest extends GitTest {
	...
	public void testStashCreateIncludeUnstaged() throws Exception {
		...
		project = getProjectDataFromInitialObject(project);

		String filename1 = "test2.txt"; //$NON-NLS-1$
		String filename2 = "test3.txt"; //$NON-NLS-1$

		createFileUsingPostRequest(project, filename1);
		createFileUsingPostRequest(project, filename2);
	...
	public void testStashApplyEmpty() throws Exception {
		...
		assertEquals(GitConstants.STASH_ILLEGAL_REF_MESSAGE, new JSONObject(response.getText()).getString("Message"));
	}
	...
	public void testStashApplyAll() throws Exception {
		...
		JSONObject indexedFileJSON = createFileUsingPostRequest(project, indexedFile);
		addFile(indexedFileJSON);
		createFileUsingPostRequest(project, untrackedFile);
	...
	public void testStashIllegalOperationType() throws Exception {
		...
		WebRequest request = getStashPostRequest(location);
	...
	public void testStashListPaginated() throws Exception {
		...
		for (String filename : filenames) {
			createFileUsingPostRequest(project, filename);
			stashCreate(project, true);
		}
	 ...
	 * @return
	 */
	static WebRequest getStashPostRequest(String location) {
		String requestURI = toAbsoluteURI(location);
