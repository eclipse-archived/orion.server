...
public class WelcomeFileFilter implements Filter {
	...
	private static final List<String> SERVLET_PATHS = Arrays.asList("/file", "/workspace/", "/filesystems", "/prefs", "/search", "/site"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
