...
public class WelcomeFileFilter implements Filter {
	...
	private static final List<String> SERVLET_PATHS = Arrays.asList("/auth2", "/login", "/hosted", "/file", "/workspace/", "/filesystems", "/prefs", "/search", "/git", "/users", "/site", "/xfer", "/help"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ //$NON-NLS-9$ //$NON-NLS-10$
