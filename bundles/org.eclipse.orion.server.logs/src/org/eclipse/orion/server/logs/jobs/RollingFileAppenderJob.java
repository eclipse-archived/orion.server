...
public class RollingFileAppenderJob extends TaskJob {
	...
	public RollingFileAppenderJob(String userRunningTask, ILogService logService, URI baseLocation,
			String appenderName) {
	...
	protected IStatus performJob() {
		try {
			...
			FileAppenderResource fileAppender = new RollingFileAppenderResource();
