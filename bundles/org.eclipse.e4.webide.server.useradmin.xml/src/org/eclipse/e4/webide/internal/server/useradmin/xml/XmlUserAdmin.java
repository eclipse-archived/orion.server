 ...
 *******************************************************************************/
package org.eclipse.e4.webide.internal.server.useradmin.xml;
...
import org.eclipse.e4.webide.server.useradmin.EmptyAuthorization;
import org.eclipse.e4.webide.server.useradmin.WebIdeAuthorization;
...
public class XmlUserAdmin extends EclipseWebUserAdmin {
	...
	private Map<String, org.eclipse.e4.webide.server.useradmin.User> usersMap;
	private Map<String, org.eclipse.e4.webide.server.useradmin.Role> rolesMap;
	...
	public Collection<org.eclipse.e4.webide.server.useradmin.User> getUsers() {
