 ...
 *******************************************************************************/
package org.eclipse.e4.webide.server.resources;
...
/**
 * Copied from org.eclipse.core.resources and modified.
 */
public class UniversalUniqueIdentifier implements Serializable, Cloneable {
	...
	public Object clone() {
		try {
			...
			Assert.isTrue(false, "Clone is known to be supported");
			return null;
		}
	}
