...
public class ListPullRequestsJob  extends TaskJob {
	...
	public ListPullRequestsJob(String userRunningTask, String url, URI cloneLocation, String host, String hostUser, String project, Object cookie) {
	...
	private IStatus doList(IProgressMonitor monitor) throws JSONException, URISyntaxException, HttpException, IOException, CoreException {
		...
		try {
			...
			if (statusCode == HttpStatus.SC_OK) {
				...
				String msg = NLS.bind("Not authorized to call, host is not a known GitHub host", toCall);
