...
public class GitUtils {
	 ...
	 * @throws CoreException
	 */
	public static <T extends GitObject> PaginatedResult paginate(Collection<T> collection, int pageNo, int pageSize) throws JSONException, URISyntaxException, IOException, CoreException {
