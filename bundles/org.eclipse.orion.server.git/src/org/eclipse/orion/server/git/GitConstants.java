...
public class GitConstants {
	...
	public static final String STASH_DROP_ILLEGAL_REF_MESSAGE = "Illegal stash ref value. Should be a positive number or -1 if all refs should be dropped"; //$NON-NLS-1$
	...
	public static final String STASH_MISSING_OPERATION_TYPE = "Missing operation type."; //$NON-NLS-1$

	public static final int STASH_DEFAULT_PAGE_SIZE = 10;

	public static final String STASH_ILLEGAL_NEXT_LOCATION_FORMAT_MESSAGE = "Illegal next location format"; //$NON-NLS-1$
