 ...
 * an XML file.
 */
public class XmlCredentialsService implements IOrionCredentialsService {
	...
	public XmlCredentialsService(URL entry) {
		try {
	...
	public boolean deleteUser(org.eclipse.orion.server.useradmin.User user) {
