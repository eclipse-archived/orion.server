...
public class ResourceShapeParser extends Parser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "PROPERTIES", "NESTED_PROPERTIES", "PROPERTY_NAME", "WILDCARD", "WS", "','", "'{'", "'}'"
    };
    ...
    public String[] getTokenNames() { return ResourceShapeParser.tokenNames; }
    public String getGrammarFileName() { return "src/org/eclipse/orion/server/core/resources/ResourceShape.g"; }
