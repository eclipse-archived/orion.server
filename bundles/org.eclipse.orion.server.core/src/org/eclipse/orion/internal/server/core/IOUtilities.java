...
public class IOUtilities {
	...
	public static Map<String, String> parseMultiPart(final InputStream requestStream, final String boundary) throws IOException {
		...
		try {
			String[] line;		//line[0] - line, line[1] - newline character (\n,\r\n)
			while (!end) {
				line = getLine(reader);
	...
	/**
	 * Returns next line and line delimiter from reader
	 * @param reader Reader to read from
	 * @return String array containing line and newline character(s)
	 * @throws IOException
	 */
