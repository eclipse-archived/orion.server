...
public class SiteConfigurationConstants {
	...
	/**
	 * Non-standard HTTP request header indicating the action (start/stop) that should be taken on 
	 * a SiteConfiguration. 
	 */
	public static final String HEADER_ACTION = "X-Action"; //$NON-NLS-1$

	/**
	 * JSON representation key for 
	 */
	 ...
	 * JSON representation key for 
	 */
	public static final String KEY_HOST_DOMAIN = "HostDomain"; //$NON-NLS-1$
